...
@section('content')
<div class="home">
    <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="{{$artiste->image}}" data-speed="0.8"></div>
    <div class="home_container">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="home_content text-center">
                        <div class="home_title"><h1>{{$artiste->name}}</h1></div>
                        <div class="home_subtitle text-center"><a class="category" href="{{route('show-category',$artiste->category->id)}}">{{$artiste->category->name}}</a></div>
                    </div>
                </div>
            </div>
        </div>
